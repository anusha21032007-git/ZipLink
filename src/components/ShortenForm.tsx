...
const ShortenForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResult(data);
      // Refresh the list of recent links
      setRecentLinks(getStoredLinks());
    ...
    <div className="w-full max-w-3xl mx-auto space-y-6">
            ...
            {result && (
              ...
              >
                ...
                <div className="flex items-center justify-between border-b border-white/10 pb-3">
                  ...
                  <div className="flex items-center gap-1.5 px-2.5 py-1 bg-white/5 border border-white/10 rounded-full text-[10px] text-white/70">
      ...
      {recentLinks.length > 0 && (
        <motion.div
          initial={{ opacity: 0, y: 15 }}
          animate={{ opacity: 1, y: 0 }}
          className="relative bg-white/[0.02] border border-white/10 backdrop-blur-2xl rounded-2xl p-5 md:p-6 space-y-4"
        >
          <div className="flex justify-between items-center pb-2 border-b border-white/5">
            ...
            <button 
              ...
              className="text-[9px] uppercase tracking-wider text-red-400/70 hover:text-red-400 flex items-center gap-1 transition-colors"
            >
          ...
          <div className="space-y-2.5 max-h-[250px] overflow-y-auto pr-1">
            {recentLinks.map((link) => (
              <div 
                key={link.id} 
                className="flex items-center justify-between p-3.5 rounded-xl bg-white/[0.02] hover:bg-white/[0.04] border border-white/5 hover:border-white/10 transition-all duration-200"
              >
                ...
                <div className="flex items-center gap-3">
                  {/* Click Badge */}
                  <div className="px-2.5 py-1 bg-white/5 rounded-full border border-white/5 text-[10px] text-white/80 flex items-center gap-1">
                  ...
                  <div className="flex gap-1.5">
                    ...
                    <button
                      ...
                      className="p-2 bg-white/5 hover:bg-white/10 border border-white/5 rounded-lg text-white/70 hover:text-white transition-colors"
                    >
                      {copiedId === link.id ? (
